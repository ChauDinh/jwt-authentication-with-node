...
export class UserResolver {
  @Query(() => String)
  hello() {
    return "JWT Authentication with Node and React!";
  }
  ...
  async register(
    ...
    if (user) throw new Error("The user has already existed!");
  ...
  async login(
    ...
    if (!valid) throw new Error("oops! something went wrong");
